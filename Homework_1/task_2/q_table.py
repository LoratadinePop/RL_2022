...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        self.epsilon += t * (self.eps_end - self.eps_begin) / self.nsteps
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        sample_list = [self.env.action_space.sample(), best_action]
        sample_index = np.random.choice(a=[0, 1], size=1, p=[self.epsilon, 1-self.epsilon])
        return sample_list[sample_index[0]]
